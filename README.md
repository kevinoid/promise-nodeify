...
[![Build Status](https://img.shields.io/github/actions/workflow/status/kevinoid/promise-nodeify/node.js.yml?branch=main&style=flat&label=build)](https://github.com/kevinoid/promise-nodeify/actions/workflows/node.js.yml?query=branch%3Amain)
